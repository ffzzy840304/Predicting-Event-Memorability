           ...
           # Load imaegs from given directory
            ...
            for img_name in image_names:
                ...
                if ext.lower() in img_extensions:
                    ...
                    f=open('/path/to/datasets/our_dataset_name/splits/'+'val_'+split_index+'.txt')
                    lines=f.readlines()
                    count=0
                    image_id=0
                    for line in lines:
                        ...
                        if spt[0]==img_name:
                           ...
                           break
                        count=count+1
                    with open('/path/to/datasets/our_dataset_name/splits/split_name/'+'val_'+split_index+'.csv', 'r') as file:
