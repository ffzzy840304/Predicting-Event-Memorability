...
def main():
    ...
    parser.add_argument('--experiment', default='trained_models', type=str, help='Experiment name. Usually no need to set' )
    parser.add_argument('--dataset-root', default='datasets/lamem/', type=str, help='Dataset root directory')
    ...
    if hps.eval_images != '':
        ...
        for m in range(0,len(f_list)):
           ...
           result=amnet.predict_memorability(sub_dir)
